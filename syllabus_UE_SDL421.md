...
3. Déroulez légèrement la page de haut en bas, jusqu'au premier poème intitulé « SPLEEN ET IDÉAL ». 
4. Commencez la sélection à partir de ce poème (y compris le titre). Maintenez la sélection puis déroulez progressivement la page de haut en bas, jusqu'au dernier poème intitulé « LES METAMORPHOSES DU VAMPIRE ». Arrêtez la sélection à la fin de ce dernier poème. 
5. Effectuez la copie, puis basculez de nouveau vers la page d'accueil de la plateforme Voyant Tools. 
6. Coller le texte copié dans le champ de texte qui apparaît en encadré au milieu de la page.
7. Cliquez sur le bouton **Révéler** en bleu, à droite du champ de texte.

Alternativement, vous pouvez choisir d'effectuer les tâches à partir de l'étape numéro jusqu'à l'étape numéro 6 en un seul bloc. Pour se faire, copier l'URL de la page web de l'oeuvre *Le Fleurs du mal* que voici: https://www.gutenberg.org/cache/epub/6099/pg6099.txt, puis collez-la dans le champ de texte de la plateforme Voyant Tools.
Attention !!! En choisissant cette méthode simplifiée, le texte que Voyant Tools traitera comportera des extras correspondant aux métadonnées de la page web, à la préface de l'oeuvre, ainsi que d'autres informations non littéraires. Pour éviter ces intrusions qui peuvent considérablement fausser l'analyse, il est recommandé de s'en tenir aux six étapes indiquées plus haut.

En outre, Voyant vous offre, à partir du champ de texte, la possibilité d'insérer un ou plusiers textes, un ou plusieurs corpus déjà constitués, depuis votre ordinateur. Par exemple, vous pouvez choisir de sauvegarder une copie de l'oeuvre *Les Fleurs du mal* dans votre ordinateur, pour une utilisation ultérieure (Attention !! Voyant Toos ne sauvegarde pas les textes que vous y avez copiés ou insérés depuis votre ordinateur). Si vous souhaitez suvegarder le texte de l'oeuvre dans votre ordinateur, procédez comme suit :
- mettez-vous sur le bureau de votre ordinateur ; dans le champ de recherche sur l'angle gauche en bas de votre écran, à côté du logo de *Windows*, entre l'expression (la chaîne de caractères) "blocnotes" (il s'agit du nom d'un éditeur de texte libre), puis cliquez sur « Entrez » ; 
- ouvrez l'éditeur de texte blocnotes, puis collez le texte de l'oeuvre *Le Fleurs du mal* ;
- sauvegardez le fichier dans un répertoire de votre ordinateur, en prenant de lui donner un nom suivi de l'extension *.txt*.

La prochaine fois que vous voudrez analyser ce texte sous Voyant Tools, vous aurez le choix entre copier et coller le texte à partir du fichier sauvegardé, soit importer le fichier dans Voyant Tools directement de votre ordinateur.

**N.B. Les différentes procédures décrites ici n'ont été testées que dans un ordinateur. Il n'est pas certain que vous puissiez les reproduire comme telles à partir d'un téléphone portable !!**

Si tout s's passé comme prévu, après l'étape 7, la plateforme Voyant Tools devrait maintenant affichier des graphiques coloriés et chatoyants, qui n'attendent plus que votre perspicacité pour être interprétées à bon escient. 