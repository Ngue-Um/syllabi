...
6. Coller le texte copié dans le champ de texte qui apparaît en encadré au milieu de la page (vous pouvez utiliser la combinaison de touches *CTRL + V*).
...
**Attention !!!** En choisissant cette méthode simplifiée, le texte que *Voyant Tools* traitera comportera des extras correspondant aux métadonnées de la page web, y compris la préface de l'oeuvre, ainsi que d'autres informations non littéraires. Pour éviter ces intrusions qui peuvent considérablement fausser l'analyse, il est recommandé de s'en tenir aux six étapes indiquées plus haut.
