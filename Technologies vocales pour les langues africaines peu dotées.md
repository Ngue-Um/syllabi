...
### Code du cours : LACC 2332  
**Niveau** : Deuxième année (formation des enseignants)  
**Semestre** : 1  
**Volume horaire** : 45 heures (30 heures de cours magistral, 15 heures de travaux pratiques)  
**Crédits** : 3  
...
- Accès à un ordinateur équipé d’un microphone et d’une connexion Internet stable.  
- Disponibilité d’un corpus textuel d’au moins **20 000 tokens** en orthographe standardisée.  
- Compte Google pour l’utilisation de Google Colab.

---

## 6. Contenu et calendrier hebdomadaire

| Semaine | Thème | Contenu | Activités |
|---------|-------|---------|-----------|
| 1 | Introduction | Présentation du cours ; historique des technologies vocales | Cours magistral & discussion |
...
| 10 | Application et déploiement | Intégration des modèles dans des outils éducatifs | Projet |
| 11 | Aspects éthiques et socioculturels | Gouvernance des données, consentement | Séminaire |
| 12 | Présentations finales | Soutenance de projet | Évaluation |
...
| Élément | Pondération | Description |
|---------|-------------|-------------|
| Participation | 10 % | Présence, implication et participation |
| Travaux pratiques | 30 % | Constitution de corpus, entraînement de modèles |
| Test intermédiaire | 20 % | Rédaction et compréhension technique |
| Projet final | 40 % | Développement et présentation d’un prototype ASR/TTS |
...
- [Praat](https://www.fon.hum.uva.nl/praat/) (analyse phonétique)
...
- Documentation Common Voice : [https://commonvoice.mozilla.org](https://commonvoice.mozilla.org)  
- Documentation Hugging Face : [https://huggingface.co/docs](https://huggingface.co/docs)

---

## 11. Règlement du cours
...
✅ *Ce cours s’inscrit dans les tendances actuelles des technologies linguistiques et offre aux futurs enseignants les compétences pratiques nécessaires pour valoriser les langues locales dans l’ère numérique.*
